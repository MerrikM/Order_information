...
func (s *OrderService) HandleKafkaMessage(responseTopic string) func(msg kafka.Message) error {
	return func(msg kafka.Message) error {
		...
		if err := json.Unmarshal(msg.Value, &event); err != nil {
			...
			_ = s.sendKafkaResponse(responseTopic, resp)
		...
		err = s.sendKafkaResponse(responseTopic, response)
		if err != nil {
